...
def test_prompt_templates():
    ...
    for template_name in templates.list_templates():
        ...
        print(f"  - {template_name}: {info['use_case']}")
    ...
    for objects in test_objects:
        ...
        print(f"Objects {objects} -> Suggested template: {suggested}")
    
    print("\nTesting prompt generation:")
    
    # Test general description
    prompt = templates.get_prompt('general_description')
    print(f"General description prompt: {prompt}")
    
    # Test visual QA
    prompt = templates.get_prompt('visual_qa', question="What color is the main object?")
    print(f"Visual QA prompt: {prompt}")
    
    # Test food nutrition
    prompt = templates.get_prompt('food_nutrition')
    print(f"Food nutrition prompt: {prompt}")
